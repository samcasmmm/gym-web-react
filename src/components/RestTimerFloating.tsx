...
const RestTimerFloating: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 bg-gray-900 text-white rounded-xl p-3.5 shadow-2xl border border-gray-700 flex items-center gap-3.5 animate-in fade-in slide-in-from-bottom-4 duration-300">
      <div className="relative w-11 h-11 flex items-center justify-center">
        ...
        <Timer className="w-4 h-4 absolute text-white" />
      </div>

      <div className="flex flex-col">
        <span className="text-[11px] uppercase font-bold tracking-wider text-gray-400">Rest Timer</span>
      ...
      <div className="flex items-center gap-1.5 ml-2">
        ...
        <button
          ...
          className="p-1.5 rounded-md bg-red-950 hover:bg-red-900 text-red-300 hover:text-red-100 transition-colors ml-1"
          title="Dismiss"
        >
          <X className="w-4 h-4" />
        </button>
