...
const Home: React.FC = () => {
  ...
  return (
    <div className="w-full space-y-12 py-6 px-2 sm:px-4">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-950 via-gray-900 to-[#2A0808] text-white p-6 sm:p-10 lg:p-14 shadow-2xl border border-gray-800">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-500/15 border border-red-500/30 text-red-400 text-xs sm:text-sm font-bold tracking-wide uppercase">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-tight sm:leading-none">
              PUSH PAST <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF2625] via-red-400 to-amber-300">
                YOUR LIMITS.
              </span>
            </h1>

            <p className="text-gray-300 text-base sm:text-lg max-w-xl leading-relaxed font-normal">
              Log your sets, calculate 1RMs in real-time, leverage progressive overload suggestions, and explore 1,500+ exercises completely offline with IndexedDB.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <button
                ...
                className="bg-[#FF2625] hover:bg-[#e0201f] text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-lg shadow-red-500/30 flex items-center gap-3 transition-all hover:scale-102 cursor-pointer"
              >
              ...
              <Link
                to="/plans"
                className="bg-white/10 hover:bg-white/20 text-white border border-white/15 px-6 py-4 rounded-2xl font-semibold text-base backdrop-blur-sm flex items-center gap-2 transition-all cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 backdrop-blur-md hover:bg-white/10 transition-colors">
              ...
              <p className="text-3xl sm:text-4xl font-black text-white">
                {prs.length}{' '}
                <span className="text-sm font-semibold text-gray-400">records</span>
              </p>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 bg-white rounded-3xl p-6 sm:p-8 shadow-xs border border-gray-100 flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-5 rounded-2xl bg-gradient-to-b from-red-50 to-white border border-red-100 hover:shadow-md transition-all flex flex-col justify-between">
                <div>
                  <span className="px-2.5 py-1 rounded-md bg-[#FF2625] text-white text-[11px] font-black uppercase tracking-wider">
                    Push Day
                  </span>
                ...
                <button
                  ...
                  className="mt-6 w-full py-2.5 bg-[#FF2625] hover:bg-[#e0201f] text-white font-bold text-sm rounded-xl transition-colors cursor-pointer"
                >
                  Start Push
                </button>
              </div>

              <div className="p-5 rounded-2xl bg-gradient-to-b from-blue-50 to-white border border-blue-100 hover:shadow-md transition-all flex flex-col justify-between">
                <div>
                  <span className="px-2.5 py-1 rounded-md bg-blue-600 text-white text-[11px] font-black uppercase tracking-wider">
                    Pull Day
                  </span>
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleStartRoutine('Pull Workout', [
                      'barbell deadlift',
                      'pull-up',
                      'dumbbell bicep curl',
                    ])
                  }
                  className="mt-6 w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm rounded-xl transition-colors cursor-pointer"
                >
                  Start Pull
                </button>
              </div>

              <div className="p-5 rounded-2xl bg-gradient-to-b from-emerald-50 to-white border border-emerald-100 hover:shadow-md transition-all flex flex-col justify-between">
                <div>
                  <span className="px-2.5 py-1 rounded-md bg-emerald-600 text-white text-[11px] font-black uppercase tracking-wider">
                    Leg Day
                  </span>
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleStartRoutine('Legs Workout', [
                      'barbell squat',
                      'romanian deadlift',
                      'leg press',
                    ])
                  }
                  className="mt-6 w-full py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm rounded-xl transition-colors cursor-pointer"
                >
                  Start Legs
                </button>
              </div>
            ...
            <div className="h-44 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  ...
                  />
                  <Bar dataKey="volume" fill="#FF2625" radius={[6, 6, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
        ...
        <div className="lg:col-span-4 bg-white rounded-3xl p-6 sm:p-8 shadow-xs border border-gray-100 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-6">
            ...
            {prs.length === 0 ? (
              <div className="text-center py-10 bg-gray-50 rounded-2xl p-4">
              ...
              <div className="space-y-3">
                {prs.map((pr) => (
                  <div
                    key={pr.id}
                    className="p-4 rounded-2xl bg-gray-50 hover:bg-[#FFF3F4] border border-gray-100 transition-colors flex items-center justify-between"
                  >
                    <div>
                    ...
                    <div className="text-right">
                      <span className="text-xs uppercase font-bold text-yellow-600 bg-yellow-100 px-2.5 py-1 rounded-full">
          ...
          <div className="mt-8 p-4 rounded-2xl bg-gradient-to-r from-gray-900 to-gray-800 text-white">
      ...
      <section className="bg-white rounded-3xl p-6 sm:p-10 shadow-xs border border-gray-100">
        <SearchExercises
          bodyPart={bodyPart}
