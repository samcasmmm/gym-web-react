...
const ExercisesPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 space-y-8">
      {/* Page Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 sm:p-8 rounded-xl border border-gray-200/80 shadow-xs">
        <div>
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-200/80 shadow-xs space-y-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-2.5 bg-gray-50 rounded-md border border-gray-200 text-base font-semibold text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#FF2625]"
          />
        </div>
        ...
        <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1">
          {bodyParts.map((bp) => (
            <button
              ...
              className={`px-3.5 py-1.5 rounded-md text-xs sm:text-sm font-bold capitalize whitespace-nowrap transition-colors cursor-pointer ${
                selectedBodyPart === bp
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 bg-white rounded-xl border border-gray-200/80 p-8 shadow-xs">
          ...
          <button
            ...
            className="mt-4 bg-[#FF2625] text-white px-5 py-2.5 rounded-md font-bold text-sm"
          >
            Clear Filters
          </button>
        </div>
          ...
          {exercises.map((exercise) => (
            <div key={exercise.id || exercise.exerciseId} className="w-full relative group">
              ...
              <button
                ...
                className="absolute top-4 right-4 z-20 bg-gray-900/90 hover:bg-[#FF2625] text-white p-2 rounded-md shadow-md transition-colors cursor-pointer"
      ...
      {customModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-xl w-full max-w-lg overflow-hidden shadow-2xl p-6 sm:p-8 animate-in zoom-in-95 duration-200 border border-gray-200">
            ...
            <form onSubmit={handleCreateCustom} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-md border border-gray-200 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#FF2625]"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 rounded-md border border-gray-200 text-sm font-semibold capitalize"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 rounded-md border border-gray-200 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#FF2625]"
                />
              </div>
              ...
              <div className="flex justify-end gap-3 pt-4">
                <button
                  ...
                  className="px-4 py-2 rounded-md text-gray-600 hover:bg-gray-100 font-semibold text-sm"
                >
                  Cancel
                </button>
                <button
